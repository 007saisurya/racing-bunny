...
const FacilityInspiration = () => {
  return (
    <section id="track" className="py-24 md:py-32 relative overflow-hidden">
      <div className="absolute inset-0 bg-brand-navy-light/40 -z-10"></div>
      ...
      <div className="max-w-7xl mx-auto px-6 md:px-12 relative z-10">
        <div className="mb-16 md:w-2/3">
          ...
          >
            Built to be a <span className="text-transparent bg-clip-text bg-gradient-to-r from-brand-maroon to-neon-purple drop-shadow-[0_0_10px_rgba(255,16,83,0.5)]">Destination</span>.
          </motion.h2>
        ...
        <div className="grid grid-cols-1 md:grid-cols-12 gap-4 md:gap-6 md:h-[600px]">
          ...
          <motion.div 
            ...
            viewport={{ once: true }}
            className="md:col-span-8 rounded-[2rem] overflow-hidden relative group h-[400px] md:h-auto neon-box"
          >
            <img 
            ...
            <div className="absolute bottom-0 left-0 w-full p-10 z-20">
              <span className="text-3xl font-black tracking-widest uppercase drop-shadow-[0_5px_10px_rgba(0,0,0,0.8)]">The Paddock Club</span>
            </div>
          </motion.div>
          ...
          <div className="md:col-span-4 flex flex-col gap-4 md:gap-6">
            <motion.div 
              ...
              className="flex-1 rounded-[2rem] overflow-hidden relative group h-[250px] md:h-auto border border-white/10"
            >
               <img 
                 src="/pro-shop.png" 
                 alt="Pro Shop" 
